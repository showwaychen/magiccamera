...
public class Logger {
     ...
     * The log dir path
     */
    protected static String logDirPath = Environment.getExternalStorageDirectory() + "/log";
    /**
...
//            filelog.append(Constants.SDK_VERSION);
			...
			Logger.log2file(path, filelog.toString());
        }
...
//        buffer.append("-");
    ...
    private static void cleanFiles(String todayFileName) {
    	if (!TextUtils.isEmpty(Logger.logDirPath)){
    		File dir = new File(Logger.logDirPath);
