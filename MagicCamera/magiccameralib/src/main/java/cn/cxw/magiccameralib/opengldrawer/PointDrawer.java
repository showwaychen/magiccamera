...
public class PointDrawer extends OpenglesDrawer{
    ...
    boolean inflatePoints()
    {
        ...
        float[] pointarray = new float[mPoints.size() * 2 ];
        int arrayindex = 0;
        int offset = 0;
        for (GeometricElement.Point point:mPoints
                ) {
            point.convert2GlVexter(pointarray, offset, mOutputWidth, mOutputHeight);
            offset+=2;
        }
...
//            GLES20.glLineWidth(3);
            ...
            GLES20.glDrawArrays(GLES20.GL_POINTS, 0, mPoints.size());
    ...
    public void addPoints(List<GeometricElement.Point> points)
    {
